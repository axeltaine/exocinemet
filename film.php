...
<h1 data-toggle="modal" data-target="#exampleModal<?php echo $Id_movie; ?>" aria-controls="exampleModal">  <img src="<?php echo $Movie_poster?>" alt=""> </h1>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel<?php echo $Id_movie; ?>"><?php echo $Movie_name ; ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
      <?php echo $Movie_synopsis ; ?><br>
            <h2>Réalisateur :</h2>
            <?php echo $REALISATEUR ; ?><br>
            <h2>Acteurs :</h2>
            <?php echo $ACTEUR ; ?><br>
            <?php echo $Movie_trailer ; ?>
      </div>
